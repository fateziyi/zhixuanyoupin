<template>
  <div>
    <el-card style="height: 80px">
      <el-form :inline="true" class="form">
        ...
        <el-form-item>
          ...
          <el-button type="primary" size="default" @click="reset" class="modern-btn modern-btn-default">
            重置
          </el-button>
        </el-form-item>
      </el-form>
    ...
    <el-card style="margin: 10px 0px">
      <el-button type="primary" size="default" icon="Plus" @click="addRole" class="modern-btn modern-btn-primary">
        添加角色
      </el-button>
        ...
        <el-table-column align="center" label="操作" width="300px">
          ...
          <template v-slot="{ row }">
            <el-button type="primary" size="small" icon="User" @click="setPermission(row)"
              class="modern-btn modern-btn-success table-btn">
              分配权限
            </el-button>
            <el-button type="primary" size="small" icon="Edit" @click="updateRole(row)"
              class="modern-btn modern-btn-primary table-btn">
              编辑
            </el-button>

            <el-popconfirm :title="`确定删除角色：${row.roleName}?`" width="260px" @confirm="removeRole(row.id)">
              <template #reference>
                <el-button type="primary" size="small" icon="Delete" class="modern-btn modern-btn-danger table-btn">
                  删除
                </el-button>
              </template>
            </el-popconfirm>
    ...
    <el-dialog v-model="dialogVisite" :title="roleParams.id ? '更新角色' : '添加角色'">
      ...
      <template #footer>
        <el-button type="primary" size="default" @click="dialogVisite = false" class="drawer-btn drawer-btn-cancel">
          取消
        </el-button>
        <el-button type="primary" size="default" @click="save" class="drawer-btn drawer-btn-confirm">
          确定
        </el-button>
      </template>
    </el-dialog>
    ...
    <el-drawer v-model="drawer">
      ...
      <template #footer>
        <div style="flex: auto">
          <el-button @click="drawer = false" class="drawer-btn drawer-btn-cancel">
            取消
          </el-button>
          <el-button type="primary" @click="confirmClick" class="drawer-btn drawer-btn-confirm">
            确定
          </el-button>
        </div>
      </template>
